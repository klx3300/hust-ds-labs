 ...
 * @Return Success or Failure
 */
// int CreateBiTree(TreeNode * head, int * definition, int lengthOfDef);
 ...
 */
int InsertChild(TreeNode * head, int index, int LorR, TreeNode * subTree);
 ...
 * @Return Success or Failure
 */
int DeleteChild(TreeNode * head, int index, int LorR);
